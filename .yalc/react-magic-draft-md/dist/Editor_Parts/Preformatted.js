...
export function Preblock(_a) {
    ...
    return React.createElement(tagName, Object.assign({ ref: ContainerRef }, otherProps), cloneChildrenWithProps(children, { "parentMoveCaret": MoveCaret, "parentAddLine": AddEmptyLine }));
}
...
export function CodeItem(_a) {
    ...
    function ComponentActivation(state) {
        ...
        if (!state) {
            ...
            if (CodeElementRef.current && CodeElementRef.current.textContent
                ...
                const NewCodeContent = (_c = CompileAllTextNode()) === null || _c === void 0 ? void 0 : _c.replace('\u00A0', '');
                if (!NewCodeContent)
        ...
        mutationList.forEach((Record) => {
            ...
            Record.removedNodes.forEach((Node) => {
                ...
                if (TextBlocksMapRef.current.get(Node)
                    ...
                    if (CodeElementRef.current && CodeElementRef.current.textContent
                        && CodeElementRef.current.parentNode && CodeElementRef.current.parentNode.nodeName.toLowerCase() === 'pre') {
                        const NewCodeContent = (_a = CompileAllTextNode()) === null || _a === void 0 ? void 0 : _a.replace('\u00A0', '');
                        if (NewCodeContent)
                            UpdateCodeElement(NewCodeContent);
                    }
                }
    ...
    return React.createElement(tagName, Object.assign(Object.assign({}, otherProps), { ref: CodeElementRef }), [

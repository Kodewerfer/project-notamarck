...
export const IPCActions = {
  APP: {
    ...
    GET_WORK_SPACE_TAGS_PATH: 'APP:GET_WORK_SPACE_TAGS_PATH',
    GET_RECENT_WORK_SPACES: 'APP:GET_RECENT_WORK_SPACES',
    REMOVE_FROM_RECENT_WORK_SPACES: 'APP:REMOVE_FROM_RECENT_WORK_SPACES',
    SET_WORK_SPACE: 'APP:SET_WORK_SPACE',
    GET_APP_KEY_BINDING: 'APP:GET_APP_KEY_BINDING',
    PUSH: {
  ...
  SHELL: {
    //using shell from electron to run outside command
  ...
  DATA: {
    ...
    // Tags
    READ_AND_SET_TAG_AS_EDITING: 'DATA:READ_AND_SET_TAG_AS_EDITING',
    ...
    // scroll locations
    GET_TAG_PAGE_SCROLL_LOCATION: 'DATA:GET_TAG_PAGE_SCROLL_LOCATION',
    UPDATE_TAG_PAGE_SCROLL_LOCATION: 'DATA:UPDATE_TAG_PAGE_SCROLL_LOCATION',
    // active file
  ...
  FILES: {
    ...
    SAVE_AS_NEW_FILE: 'FILES:SAVE_AS_NEW_FILE',
    // renaming

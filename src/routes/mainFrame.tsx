...
function MainFrame() {
  ...
  return (
    <>
      <motion.div className="h-screen w-screen bg-gray-50 antialiased dark:bg-gray-900">
        <LayoutGroup>
          {/*Sidebar*/}
          <motion.aside
            layout
          ...
          {/*Main editor area*/}
          <motion.main layout className="ml-96 flex h-screen flex-col dark:bg-slate-200">
